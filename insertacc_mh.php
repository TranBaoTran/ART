...
<body>
<div class="sua">
<form  method="POST" action="?view=show2&action=insertacc" name="frmCapnhat" id="frmCapnhat">
...
<table id="bang">
    <tr>
        <td>Tên đăng nhập:</td>
        <td><input style="height:25px; width:220px; float:left; margin-left:40px" name="tendn" type="text" id="tendn" value="" /></td>
    </tr>
    <tr>
        <td>Mật khẩu:</td>
